                                        ...
                                        <form class="me-auto" action="" method="">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#quicksearchmodal"><i class="fas fa-search"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                        <!-- end quick search -->
                                        ...
                                        <ul class="navbar-nav pe-5 me-5">
                                            ...
                                            <li class="nav-item dropdown">
                                                <a href="javascript:void(0);" class="dropdown-toggle" data-bs-toggle="dropdown">
                                                    ...
                                                    <img src="./assets/img/users/user1.jpg" class="rounded-circle" alt="user1" width="25" />
                                                </a>

                                                <div class="dropdown-menu">
                                                    <a href="javascript:void(0);" class="dropdown-item"><i class="fas fa-user text-muted me-2"> Profile</i></a>
                                                    <a href="javascript:void(0);" class="dropdown-item"><i class="fas fa-user text-muted me-2"> Settings</i></a>
                                                    <a href="javascript:void(0);" class="dropdown-item"><i class="fas fa-user text-muted me-2"> Activite Log</i></a>
                                                    <a href="javascript:void(0);" class="dropdown-item"><i class="fas fa-user text-muted me-2"> Logout</i></a>
                                                </div>
                                            </li>
                                            <!-- user account -->
